...
#include <Gsender_32Info.h>     // Stores passwords and account information
...
class Gsender
{
   ...
   private:
       ...
       const char* SMTP_SERVER = SMTP_SERVER_;
       const char* EMAILBASE64_LOGIN = EMAILBASE64_LOGIN_;
       const char* EMAILBASE64_PASSWORD = EMAILBASE64_PASSWORD_;
